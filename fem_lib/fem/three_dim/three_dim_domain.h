...
namespace fem::three_dim {
    ...
    struct Subdomain {
        ...
        size_t zBeginNum{ 0 };   /// Number of begin Z coordinate line (starts with 1)
        size_t zEndNum{ 0 };     /// Number of begin Z coordinate line (starts with 1)
    };
    ...
    struct S1Edge {
        ...
        size_t zBeginNum{ 0 }; /// Number of begin Z coordinate line (starts with 1)
        size_t zEndNum{ 0 };   /// Number of end Z coordinate line (starts with 1)
    ...
    struct Domain {
        ...
        size_t Kz{}; /// count of Z coordinate lines
        ...
        std::vector<double> Z{}; /// Vector of Z coordinate lines of Kz size
